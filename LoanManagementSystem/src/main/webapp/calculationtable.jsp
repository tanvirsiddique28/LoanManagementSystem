...
<div class="container-fluid">
  <div class="row">
	...
	<div>
	 <form action="/searchloanitem" method="post">
     <button type="submit" class="btn btn-dark  w-10  p-3" >Search</button>
     <input type="text" class="w-15  p-3" id="serach" name="id" placeholder="enter print id" >
     </form>
    </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>${l.monthlypayble}</td>
                    <td>${l.totalypayble}</td>
                    <td><form action="/updateloan/${l.getId()}"><button type="submit" class="btn btn-success">Update</button></form></td>
                    <td><form action="/deleteloan/${l.getId()}"><button type="submit" class="btn btn-danger">Delete</button></form></td>
                  </tr>
                  </c:forEach>
