...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class=" pt-3 pb-2 mb-3 border-bottom text-center">
        <h1 class="h2">Welcome to Loan Management System</h1>
        </div>
  ...
  <div class="card-body  bg-dark">
    <h5 class="card-title text-white">Total Loan Catagories</h5>
    <p class="card-text text-white ">${allLonaType}</p>
  </div>
</div>
    </div>
    <div class="col col-md-4">
      <div class="card" style="width: 18rem;">
  <div class="card-body bg-dark">
    <h5 class="card-title text-white">Number of Customer</h5>
    <p class="card-text text-white">${allCustomers}</p>
  </div>
</div>
    </div>
    <div class="col col-md-4">
     <div class="card" style="width: 18rem;">
  <div class="card-body bg-dark">
    <h5 class="card-title text-white">Number of Loan Applicants</h5>
    <p class="card-text text-white">${allApplicants}</p>
  ...
  <div class="row mt-5">
    <div class="col col-md-4">
      <div class="card" style="width: 18rem;">
  <div class="card-body bg-dark">
    <h5 class="card-title text-white">Number Of Approved Loans</h5>
    <p class="card-text text-white">${allAppLoans}</p>
  </div>
</div>
    </div>
    <div class="col col-md-4">
      <div class="card " style="width: 18rem;">
  <div class="card-body bg-dark">
    <h5 class="card-title text-white">Number Of Not Approved Loans</h5>
    <p class="card-text text-white">${allNotAppLoans}</p>
  </div>
</div>
    </div>
    <div class="col col-md-4">
     <div class="card" style="width: 18rem;">
  <div class="card-body bg-dark ">
    <h5 class="card-title text-white">Dismissed Accounts</h5>
    <p class="card-text text-white">${allDissLoans}</p>
    <p></p>
     <p></p>
     <p></p>
  </div>
