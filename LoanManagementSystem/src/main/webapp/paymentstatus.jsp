...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class=" pt-3 pb-2 mb-3 border-bottom text-center">
        ...
        <div class="container">
         <form action="/searchcustomerpay" method="post">
          <div class="row">
  ...
  <tbody>
  <c:forEach var="con" items="${p}">
    <tr>
      <td>${con.lastpaydate}</td>
      <td>${con.loantype}</td>
      <td>${con.mothlypayble}</td>
      <td>${con.extracharge}</td>
      <td>${con.totalpayble}</td>
    </tr>
    </c:forEach>
  </tbody>
</table>
