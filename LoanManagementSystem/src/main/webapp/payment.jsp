      ...
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/paymentstatus">
              <span data-feather="layers"></span>
             Withdrawn
             <hr>
            </a>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class=" pt-3 pb-2 mb-3 border-bottom text-center">
        <h1 class="h2">Payment</h1>
          ...
          <!--form start-->
        <div class="container">
        <form action="/searchappcus" method="post">
          <div class="row">
...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Current Payble</th>
...
<hr>
         <form action="/calpa" method="post">
          <div class="row mt-4">
            ...
            <div class="col col-md-2">
              <label for="nid" class="form-label">Extra Charge</label>
            </div>
            <div class="col col-md-3">
              <input type="text" class="form-control" id="extracharge" name="extracharge" value="0"  >
            </div>
          </div>

          
              <button type="submit" class="btn btn-dark" formaction="/calpay/${customerid}">Pay</button>
           ...
           <span style="color:black;" >${warn2}</span><br>
           &nbsp; &nbsp; &nbsp; &nbsp;<span style="color:black;" >${msg2}</span><br>
           &nbsp; &nbsp; &nbsp; &nbsp;<span style="color:black;" >${msg3}</span><br>
