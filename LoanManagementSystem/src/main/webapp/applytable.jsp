...
<div class="container-fluid">
  <div class="row">
	...
	<div>
     ...
     <input type="text" class="w-15  p-3" id="serach" name="id" placeholder="enter applicant id" >
     </form>
    </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><form action="/updateapp/${l.getId()}"><button type="submit" class="btn btn-success">Update</button></form></td>
                    <td><form action="/deleteapp/${l.getId()}"><button type="submit" class="btn btn-danger">Delete</button></form></td>
                  </tr>
                  </c:forEach>
