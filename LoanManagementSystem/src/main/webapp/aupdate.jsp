                  ...
                  <div class="row">
                            <div class=" mb-4">
                              <div class="form-outline">
                                ...
                                <label class="form-label" for="id" >Application Id</label>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-outline mb-4">
                            <input type="text" id="nid" name="nid" class="form-control form-control-lg" value="${l.getNid()}" />
                            <label class="form-label" for="nid"  >NID Number</label>
                          </div>
                          
                           <div class="form-outline mb-4">
                            <input type="text" id="mobile" name="age" class="form-control form-control-lg" value="${l.getAge()}" />
                            <label class="form-label" for="mobile" >Age</label>
                          </div>
                          
                           <div class="form-outline mb-4">
                            <input type="text" id="nid" name="tin" class="form-control form-control-lg" value="${l.getTin()}" />
                            <label class="form-label" for="nid"  >TIN Number</label>
                          </div>
                          
                           <div class="form-outline mb-4">
                            <input type="text" id="nid" name="netincome" class="form-control form-control-lg" value="${l.getNetincome()}" />
                            <label class="form-label" for="nid"  >Net Income</label>
                          </div>

                          <div class="form-outline mb-4">
                            <input type="text" id="nid" name="gurantor" class="form-control form-control-lg" value="${l.getGurantor()}" />
                            <label class="form-label" for="nid"  >Guarantor Name</label>
                          </div>
                          
                           <div class="form-outline mb-4">
                            <input type="text" id="mobile" name="gurantornid" class="form-control form-control-lg" value="${l.getGurantornid()}" />
                            <label class="form-label" for="mobile" >Guarantor NID Number</label>
                          </div>
                          ...
                          <div class="form-outline mb-4">
                            <input type="text" id="nid" name="months" class="form-control form-control-lg" value="${l.getMonths()}" />
                          ...
                          <div class="form-outline mb-4">
                            <input type="text" id="age"  name="totalpayble" class="form-control form-control-lg" value="${l.getTotalpayble()}" />
                            <label class="form-label" for="age">Total Payble</label>
                          </div>
                          
                           <div class="form-outline mb-4">
                            <input type="text" id="age"  name="status" class="form-control form-control-lg" value="${l.getStatus()}" />
                            <label class="form-label" for="age">Status</label>
                          </div>
