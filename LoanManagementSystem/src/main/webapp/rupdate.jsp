             ...
             <form action="/updater" method="post">
                  ...
                  <div class="row">
                          ...
                          <div class="row">
                            <div class=" mb-4">
                              <div class="form-outline">
                                <input type="text" id="name"  name="email" class="form-control form-control-lg" value="${l.getEmail()}" />
                          ...
                          <div class="form-outline mb-4">
                            <input type="text" id="nid" name="mobile" class="form-control form-control-lg" value="${l.getMobile()}" />
                            <label class="form-label" for="nid"  >Mobile</label>
                          </div>
          
                          <div class="row">
                            <div class=" mb-4">
                              <div class="form-outline">
                                <input type="text" id="email" name="address" class="form-control form-control-lg" value="${l.getAddress()}" />
                          ...
                          <div class="form-outline mb-4">
                            <input type="text" id="mobile" name="gender" class="form-control form-control-lg" value="${l.getGender()}" />
