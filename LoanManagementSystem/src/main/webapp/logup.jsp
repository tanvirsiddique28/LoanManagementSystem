...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <button type="button" class="btn btn-dark">Approved Loans</button>
  </form>
   -->
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="login.jsp"></a>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class=" pt-3 pb-2 mb-3 border-bottom text-center">
        <h1 class="h2"> User Sign Up form</h1>
        </div>
        ...
        <section class="h-100 bg-dark">
                  ...
                  <div class="card card-registration my-4">
                    <div class="row g-0">
                      <div class="col-xl-6 d-none d-xl-block">
                        <img height="800px" width="600px" src="images/cuap.jpg"
                          alt="Sample photo" class=""
          ...
          <form action="/logupinsert" method="post">
                          <div class="row">
                            <div class=" mb-4">
                          ...
                          <div class="form-outline mb-4">
                            ...
                            <label class="form-label" for="nid"  >Password</label>
                          </div>
                          ...
                          <div class="d-flex justify-content-end pt-3">
                            <button type="submit" formaction="/reset" class="btn btn-light btn-lg">Reset all</button>
