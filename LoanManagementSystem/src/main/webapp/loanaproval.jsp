  ...
  <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class=" pt-3 pb-2 mb-3 border-bottom text-center">
        <h1 class="h2 " >Loan Approval</h1>
      </div>
      
       <div class="container">
         <form action="/searchapploan" method="post">
          <div class="row">
...
<hr>
  ...
  <tbody>
    <tr>
      ...
      <td>${cname}</td>
      <td>${cnid}</td>
      <td>${cage}<br><span style="color:red;" >${s1}</span></td>
      <td>${ctin}</td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td>${cni}<br><span style="color:red;" >${s2}</span></td>
      <td>${gname}</td>
      <td>${gnid}</td>
      <td>${ltt}</td>
      <td>${la}</td>
  ...
  <tbody>
    ...
    <tr>
     <td> <form action="/approve/${cid}"><button type="submit"  class="btn btn-dark">Approved</button></form></td>
      <td> <button type="button" class="btn btn-dark">Not Approved</button></td>
    </tr>
  </tbody>
</table>

          <div class="mt-5">
           &nbsp; &nbsp; &nbsp; &nbsp;<span style="color:black;" >${msg1}</span><br>
           &nbsp; &nbsp; &nbsp; &nbsp;<span style="color:black;" >${msg2}</span><br>
           &nbsp; &nbsp; &nbsp; &nbsp;<span style="color:black;" >${msg3}</span>
          </div>
